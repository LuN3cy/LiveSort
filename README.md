<p align="center">
  <img src="LiveSortApp/static/livesort-brand-icon.png" width="72" height="72" alt="LiveSort icon">
</p>
...
![Interest Curve](LiveSortApp/static/readme-interest-curve.png)
...
![Seamless Transition](LiveSortApp/static/readme-transition-flow.png)
...
- `LiveSortApp/static/*.png`：品牌图标与说明页配图
