<p align="center">
  <img src="LiveSortApp/static/livesort-brand-icon.svg" width="72" height="72" alt="LiveSort icon">
</p>
...
![Interest Curve](LiveSortApp/static/readme-interest-curve.svg)
...
![Seamless Transition](LiveSortApp/static/readme-transition-flow.svg)
...
## 项目结构
- `LiveSortApp/templates/index.html`：主界面
- `LiveSortApp/templates/algorithm.html`：算法说明页
- `LiveSortApp/static/lame.min.js`：浏览器端 MP3 编码器
- `LiveSortApp/static/*.svg`：品牌图标与说明页配图
...
3. 推送到 `main` 或 `master` 后会自动触发 `.github/workflows/deploy-pages.yml`。
4. 工作流会将 `LiveSortApp/templates/index.html`、`LiveSortApp/templates/algorithm.html` 与 `LiveSortApp/static/` 打包并发布为 Pages 站点。
